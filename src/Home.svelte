<script>
    import Typing from './TypingAnimation.svelte';
</script>
...
<style>
    ...
    10% {
        opacity: 0; /* Remain invisible during the delay */
    }
    100% {
...
<header>
    <div class="header-content">
        <a href="/assets/self-portrait-close.jpg" target="_blank" class="image-link">
